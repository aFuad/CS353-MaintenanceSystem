<?php
  ...
  $descr;
    ...
    $insertQuery = "SELECT count(repairment_id), full_name FROM repairments NATURAL JOIN user GROUP BY product_id ORDER BY count(repairment_id) DESC LIMIT 1";
...
<head>
  ...
  <style type="text/css">
    #employee{
      background-image: url("./images/user_problem.png");
      width: 150px;
      height: 150px;
